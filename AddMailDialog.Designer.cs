namespace ThunderAutoConfig_NET
{
    partial class AddMailDialog
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "Введите почту, которую хотите добавить.";
            // 
            // label2
            // 
            ...
            this.label2.Text = "Значение email не является правильным email адресом!\n";
            ...
            this.label3.Text = "Введите адрес IMAP";
            ...
            this.label4.Text = "Введите адрес SMTP";
            ...
            this.Name = "AddMailDialog";
            this.Text = "Добавить почту";
            this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.AddMailDialog_FormClosing);
            this.Load += new System.EventHandler(this.AddMailDialog_Load);
